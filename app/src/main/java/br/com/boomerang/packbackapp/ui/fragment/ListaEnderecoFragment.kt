 ...
 * [ListaEnderecoFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ListaEnderecoFragment.newInstance] factory method to
...
class ListaEnderecoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ListaEnderecoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                ListaEnderecoFragment().apply {
