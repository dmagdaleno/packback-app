 ...
 * [ListaEmbalagemFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ListaEmbalagemFragment.newInstance] factory method to
 * create an instance of this fragment.
 *
 */
class ListaEmbalagemFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ListaEmbalagemFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                ListaEmbalagemFragment().apply {
